...
struct Drivers {
    ...
    I2cMaster i2c{loop,
        gpio::PB6 | gpio::AF1 | gpio::Config::PULL_UP | gpio::Config::SPEED_LOW | gpio::Config::DRIVE_DOWN, // I2C1 SCL (don't forget to lookup the alternate function number in the data sheet!)
        gpio::PB7 | gpio::AF1 | gpio::Config::PULL_UP | gpio::Config::SPEED_LOW | gpio::Config::DRIVE_DOWN, // I2C1 SDA
        i2c::I2C1_INFO,
    ...
    I2cMaster::Buffer<0, 16> buffer1{channel1};
    I2cMaster::Buffer<2, 16> buffer2{channel2};
};
