...
struct Drivers {
	...
	I2cMaster i2c{loop,
		//gpio::PB(6, 1), // I2C1 SCL (don't forget to lookup the alternate function number in the data sheet!)
		//gpio::PB(7, 1), // I2C1 SDA
		gpio::Config::PB6 | gpio::Config::AF1 | gpio::Config::PULL_UP | gpio::Config::SPEED_LOW | gpio::Config::DRIVE_DOWN, // I2C1 SCL (don't forget to lookup the alternate function number in the data sheet!)
		gpio::Config::PB7 | gpio::Config::AF1 | gpio::Config::PULL_UP | gpio::Config::SPEED_LOW | gpio::Config::DRIVE_DOWN, // I2C1 SDA
		i2c::I2C1_INFO,
